...
namespace Cpu {
	...
	bool get_sensors() {
		const auto show_coretemp = Config::getB("show_coretemp");
		const auto check_temp = Config::getB("check_temp");
		Logger::debug("get_sensors(): show_coretemp=" + std::to_string(show_coretemp) + " check_temp=" + std::to_string(check_temp));
		got_sensors = false;
